...
${NEWLIB_SRC}/configure --prefix=${PREFIX} --target=sh-elf-gcc $(disable_flags) --enable-lite-exit --enable-newlib-nano-formatted-io --enable-newlib-nano-malloc --enable-target-optspace --enable-newlib-reent-small --disable-multilib
